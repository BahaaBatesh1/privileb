        ...
        if metadataObj.type == AVMetadataObjectTypeQRCode {
            ...
            if metadataObj.stringValue != nil {
                ...
                //var splittedArray = metadataObj.stringValue.components(separatedBy: ":")
                 serial_number = metadataObj.stringValue
    ...
    */
    ...
    func callScan() {
        ...
        let service = services_calls()
                ...
                service.scan_offer(user_id: "", scan_date: NSDate().getToDay(), offer_id: self.offer_id, branch_id: self.branch_id, serial_number: self.serial_number) { (res, status) in
                    if status == "ok" {
                        if res?.status == 1 {
